...
import { GPROG, GPROG_HEX } from './utils/prefixes.js';
import './utils/separator.js';
import { validateValue, validateGasLimit } from './utils/validate.js';
import '@polkadot/api';
...
import { SubmitProgramError } from './errors/program.errors.js';
...
class GearProgram extends GearTransaction {
    ...
    async allUploadedPrograms() {
        ...
        return keys.map((prog) => {
            return `0x${prog.toHex().slice(GPROG_HEX.length + 2)}`;
        });
    }
    /**
     *
